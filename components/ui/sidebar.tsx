    ...
    return (
      <div
        ...
        className={cn(
          ...
          "duration-200 ease-linear transition-[width]",
          "data-[collapsible=icon]:w-[--sidebar-width-icon]",
          variant === "floating" || variant === "inset"
            ? "relative"
            : "fixed top-16 z-10 h-[calc(100vh-4rem)]",
          side === "left"
            ? "left-0"
            : "right-0",
          state === "collapsed"
...
>(({ className, ...props }, ref) => {
  return (
    <input
      ...
      data-sidebar="input"
      className={cn(
        "flex h-8 w-full rounded-md border border-sidebar-border bg-sidebar-accent px-3 py-1 text-sm text-sidebar-foreground ring-offset-sidebar transition-[box-shadow] placeholder:text-sidebar-foreground/50 focus-visible:border-sidebar-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2 focus-visible:ring-offset-sidebar disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
